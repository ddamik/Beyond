 ...
 */
public class TmapDataVO {

    @SerializedName("features")
    public ArrayList<Features> features;

    // [ TMapDataVO Constructure ]
    public TmapDataVO() { }
    public TmapDataVO(ArrayList<Features> features) { this.features = features; }
    ...
    public class Features {
        ...
        public class GeoMetry {
            ...
            @SerializedName("coordinate") public ArrayList<GeoMetryVO> coordinates;
            public int index;
            public int num;
