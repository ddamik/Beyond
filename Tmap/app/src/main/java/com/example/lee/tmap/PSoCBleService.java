...
public class PSoCBleService extends Service {
    ...
    public final static String ACTION_BLESCAN_CALLBACK =
            "com.example.lee.tmap.Activity.ACTION_BLESCAN_CALLBACK";
    public final static String ACTION_CONNECTED =
            "com.example.lee.tmap.Activity.ACTION_CONNECTED";
    public final static String ACTION_DISCONNECTED =
            "com.example.lee.tmap.Activity.ACTION_DISCONNECTED";
    public final static String ACTION_SERVICES_DISCOVERED =
            "com.example.lee.tmap.Activity.ACTION_SERVICES_DISCOVERED";
    public final static String ACTION_DATA_RECEIVED =
            "com.example.lee.tmap.Activity.ACTION_DATA_RECEIVED";

    public PSoCBleService() {
    }
