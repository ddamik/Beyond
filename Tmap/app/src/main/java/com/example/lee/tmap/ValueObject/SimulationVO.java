...
public class SimulationVO {
    ...
    public SimulationVO(String description, int distance, int index, double latitude, double longitude, int turnType) {
    ...
    public SimulationVO(int index, int totalDistance, int totalTime, int totalFare, int distance, String description, int turnType, double latitude, double longitude) {
        this.index = index;
    ...
    public SimulationVO(int index, int distance, int turnType, String description, double latitude, double longitude) {
        this.index = index;
        this.description = description;
        this.distance = distance;
        this.turnType = turnType;
